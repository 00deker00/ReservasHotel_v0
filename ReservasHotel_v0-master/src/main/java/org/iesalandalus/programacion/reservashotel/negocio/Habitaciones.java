...
//todo pendiente de hacer
    ...
    public void insertar(Habitacion habitacion) throws OperationNotSupportedException {
        if (habitacion==null)
            throw new NullPointerException("habitacion != null");
    ...
    public void borrar(Habitacion habitacion)throws OperationNotSupportedException{
        ...
        if (buscar(habitacion) == null)
            throw new IllegalArgumentException("el habitacion no está en el array");
    ...
    private void desplazarUnaPosicionHaciaIzquierda(int indice)throws OperationNotSupportedException {
        if (indice<0 || indice > capacidad)
            throw new OperationNotSupportedException("No se puede porque está fuera del array");
