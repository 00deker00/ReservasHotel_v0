...
public class Huesped {
    ...
    public void setFechaNacimiento(LocalDate fechaNacimiento) {
        ...
        if (fechaNacimiento.isAfter(LocalDate.now()))
            throw new IllegalArgumentException("La fecha de nacimiento de un huésped no puede ser posterior a la fecha de hoy. ");
        if (fechaNacimiento.isBefore(LocalDate.of(1900, 1, 1)))
            throw new IllegalArgumentException("La fecha de nacimiento de un huésped no puede ser anterior a 1900. ");
